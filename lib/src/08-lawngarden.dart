...
class LawnAndGarden extends compendium.Compendium {

  final Map metValue  = const <int, double>{8009 : 3.3
  ,8010 : 5.5
  ,8019 : 4.5
  ,8020 : 6.3
  ,8025 : 3.5
  ...
  final Map metDescription  = const <int, String>{8009 : "carrying, loading or stacking wood, loading/unloading or carrying lumber, light-to-moderate effort"
  ...
  final Map metDescription_fr  = const <int, String>{8009 : "porter, charger ou empiler du bois, charger/décharger ou transporter du bois de charpente, effort léger à modéré"
