...
class ConditioningExercise extends compendium.Compendium {
  final Map metValue  = const <int, double>{2001 : 2.3
  ,2003 : 3.8
  ,2005 : 7.2
  ,2008 : 5.0
  ,2010 : 7.0
  ...
  final Map metDescription  = const <int, String>{2001 : "activity promoting video game (e.g., Wii Fit), light effort (e.g., balance, yoga)"
  ...
  final Map metDescription_fr  = const <int, String>{2001 : "jeu vidéo réclamant une activité (par ex. Wii Fit), effort léger (par ex. position d’équilibre, yoga)"
