...
class HomeRepair extends compendium.Compendium {

  final Map metValue  = const <int, double>{6010 : 3.0
  ,6020 : 4.0
  ,6030 : 3.3
  ,6040 : 3.0
  ,6050 : 6.0
  ...
  final Map metDescription  = const <int, String>{6010 : "airplane repair"
  ...
  final Map metDescription_fr  = const <int, String>{6010 : "réparation d'un avion"
